      ...
      <div className="container mx-auto flex justify-between items-center">
        ...
        {user && (
          <div className="hidden md:flex space-x-6">
            ...
            <Link 
              to="/history" 
              className={`hover:text-blue-200 ${location.pathname === '/history' ? 'text-green-300' : ''}`}
            >
              History
            </Link>
            <Link 
              to="/analytics" 
              className={`hover:text-blue-200 ${location.pathname === '/analytics' ? 'text-green-300' : ''}`}
            >
              Analytics
            </Link>
            <Link 
              to="/settings" 
              className={`hover:text-blue-200 ${location.pathname === '/settings' ? 'text-green-300' : ''}`}
            >
              Settings
            </Link>
          </div>
  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 bg-blue-900 text-white py-2 shadow-top">
      <div className="flex justify-around">
        ...
        <Link 
          to="/more" 
          className={`flex flex-col items-center p-2 ${['/history', '/analytics', '/settings'].includes(location.pathname) ? 'text-green-300' : ''}`}
          onClick={(e) => {
            e.preventDefault();
      ...
      {/* More menu popup */}
      <div id="mobileMoreMenu" className="hidden absolute bottom-16 right-0 bg-blue-800 rounded-tl-lg shadow-lg w-48">
        <div className="flex flex-col p-2">
          <Link 
            to="/history" 
            className={`flex items-center p-3 hover:bg-blue-700 rounded ${location.pathname === '/history' ? 'text-green-300' : ''}`}
          >
          ...
          <Link 
            to="/analytics" 
            className={`flex items-center p-3 hover:bg-blue-700 rounded ${location.pathname === '/analytics' ? 'text-green-300' : ''}`}
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <Link 
            to="/settings" 
            className={`flex items-center p-3 hover:bg-blue-700 rounded ${location.pathname === '/settings' ? 'text-green-300' : ''}`}
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
